            ...
            <div className="flex items-center justify-end mb-6">
              <div className="flex items-center space-x-3">
                ...
                <button 
                  onClick={(e) => {
                    e.stopPropagation();
                    handleWidgetExpand('analytics');
                  }}
                  className="p-1 hover:bg-gray-100 rounded"
                  title={expandedWidget === 'analytics' ? 'Minimize widget' : 'Maximize widget'}
                >
                  {expandedWidget === 'analytics' ? <Minimize2 className="w-4 h-4 text-gray-400" /> : <Maximize2 className="w-4 h-4 text-gray-400" />}
                </button>
                <div className="relative">
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      handleWidgetMenu('analytics');
                    }}
                    className="p-1 hover:bg-gray-100 rounded"
                    title="Widget options"
                  >
                  ...
                  {showWidgetMenu === 'analytics' && (
                    <div className="absolute right-0 top-8 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 min-w-32">
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('refresh', 'analytics');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        <RefreshCw className="w-4 h-4 mr-2" />
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('copy', 'analytics');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        <Copy className="w-4 h-4 mr-2" />
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('settings', 'analytics');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        <Settings className="w-4 h-4 mr-2" />
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('delete', 'analytics');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50"
                      >
                        <Trash2 className="w-4 h-4 mr-2" />
              ...
              <div className="flex items-center justify-end mb-6">
                <div className="flex items-center space-x-2">
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      handleWidgetExpand('activity');
                    }}
                    className="p-1 hover:bg-gray-100 rounded"
                    title={expandedWidget === 'activity' ? 'Minimize widget' : 'Maximize widget'}
                  >
                    {expandedWidget === 'activity' ? <Minimize2 className="w-4 h-4 text-gray-400" /> : <Maximize2 className="w-4 h-4 text-gray-400" />}
                  </button>
                  <div className="relative">
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                        handleWidgetMenu('activity');
                      }}
                      className="p-1 hover:bg-gray-100 rounded"
                      title="Widget options"
                    >
                    ...
                    {showWidgetMenu === 'activity' && (
                      <div className="absolute right-0 top-8 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 min-w-32">
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('refresh', 'activity');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <RefreshCw className="w-4 h-4 mr-2" />
                        ...
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('copy', 'activity');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <Copy className="w-4 h-4 mr-2" />
                        ...
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('settings', 'activity');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <Settings className="w-4 h-4 mr-2" />
                        ...
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('delete', 'activity');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50"
                        >
                          <Trash2 className="w-4 h-4 mr-2" />
              ...
              <div className="flex items-center justify-end mb-6">
                <div className="flex items-center space-x-2">
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      handleWidgetExpand('leaderboard');
                    }}
                    className="p-1 hover:bg-gray-100 rounded"
                    title={expandedWidget === 'leaderboard' ? 'Minimize widget' : 'Maximize widget'}
                  >
                    {expandedWidget === 'leaderboard' ? <Minimize2 className="w-4 h-4 text-gray-400" /> : <Maximize2 className="w-4 h-4 text-gray-400" />}
                  </button>
                  <div className="relative">
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                        handleWidgetMenu('leaderboard');
                      }}
                      className="p-1 hover:bg-gray-100 rounded"
                      title="Widget options"
                    >
                    ...
                    {showWidgetMenu === 'leaderboard' && (
                      <div className="absolute right-0 top-8 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 min-w-32">
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('refresh', 'leaderboard');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <RefreshCw className="w-4 h-4 mr-2" />
                        ...
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('copy', 'leaderboard');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <Copy className="w-4 h-4 mr-2" />
                        ...
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('settings', 'leaderboard');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <Settings className="w-4 h-4 mr-2" />
                        ...
                        <button 
                          onClick={(e) => {
                            e.stopPropagation();
                            handleWidgetAction('delete', 'leaderboard');
                          }}
                          className="flex items-center w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50"
                        >
                          <Trash2 className="w-4 h-4 mr-2" />
            ...
            <div className="flex items-center justify-end mb-6">
              <div className="flex items-center space-x-2">
                <button 
                  onClick={(e) => {
                    e.stopPropagation();
                    handleWidgetExpand('coaching');
                  }}
                  className="p-1 hover:bg-gray-100 rounded"
                  title={expandedWidget === 'coaching' ? 'Minimize widget' : 'Maximize widget'}
                >
                  {expandedWidget === 'coaching' ? <Minimize2 className="w-4 h-4 text-gray-400" /> : <Maximize2 className="w-4 h-4 text-gray-400" />}
                </button>
                <div className="relative">
                  <button 
                    onClick={(e) => {
                      e.stopPropagation();
                      handleWidgetMenu('coaching');
                    }}
                    className="p-1 hover:bg-gray-100 rounded"
                    title="Widget options"
                  >
                  ...
                  {showWidgetMenu === 'coaching' && (
                    <div className="absolute right-0 top-8 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 min-w-32">
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('refresh', 'coaching');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        <RefreshCw className="w-4 h-4 mr-2" />
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('copy', 'coaching');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        <Copy className="w-4 h-4 mr-2" />
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('settings', 'coaching');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                      >
                        <Settings className="w-4 h-4 mr-2" />
                      ...
                      <button 
                        onClick={(e) => {
                          e.stopPropagation();
                          handleWidgetAction('delete', 'coaching');
                        }}
                        className="flex items-center w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50"
                      >
                        <Trash2 className="w-4 h-4 mr-2" />
