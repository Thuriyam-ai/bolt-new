            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-2">
                  <Move className="w-4 h-4 text-gray-400 cursor-move" title="Drag to reorder" />
                  <button 
                    onClick={() => handleWidgetExpand('metrics')}
                  ...
                  <div className="relative">
                    <button 
                      onClick={() => handleWidgetMenu('metrics')}
                      className="p-1 hover:bg-gray-100 rounded"
                    ...
                    {showWidgetMenu === 'metrics' && (
                      <div className="absolute right-0 top-8 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 min-w-32">
                        <button 
                          onClick={() => handleWidgetAction('refresh', 'metrics')}
                        ...
                        <button 
                          onClick={() => handleWidgetAction('copy', 'metrics')}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                        ...
                        <button 
                          onClick={() => handleWidgetAction('settings', 'metrics')}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                        ...
                        <hr className="my-1" />
                        <button 
                          onClick={() => handleWidgetAction('delete', 'metrics')}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 h-full">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center space-x-2">
                  <Move className="w-4 h-4 text-gray-400 cursor-move" title="Drag to reorder" />
                  <button 
                    onClick={() => handleWidgetExpand('trends')}
                    className="p-1 hover:bg-gray-100 rounded"
                  ...
                  <div className="relative">
                    <button 
                      onClick={() => handleWidgetMenu('trends')}
                      className="p-1 hover:bg-gray-100 rounded"
                      title="Widget options"
                    >
                      <MoreHorizontal className="w-4 h-4 text-gray-400" />
                    ...
                    {showWidgetMenu === 'trends' && (
                      <div className="absolute right-0 top-8 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-10 min-w-32">
                        <button 
                          onClick={() => handleWidgetAction('refresh', 'trends')}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <RefreshCw className="w-4 h-4 mr-2" />
                          Refresh
                        ...
                        <button 
                          onClick={() => handleWidgetAction('copy', 'trends')}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <Copy className="w-4 h-4 mr-2" />
                          Copy
                        ...
                        <button 
                          onClick={() => handleWidgetAction('settings', 'trends')}
                          className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100"
                        >
                          <Settings className="w-4 h-4 mr-2" />
                          Settings
                        ...
                        <hr className="my-1" />
                        <button 
                          onClick={() => handleWidgetAction('delete', 'trends')}
                          className="flex items-center w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50"
                        >
                          <Trash2 className="w-4 h-4 mr-2" />
                          Remove
